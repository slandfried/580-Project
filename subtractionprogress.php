...
<html>
	...
	?>
	<title>Subtraction Progress</title>
	</head>
	...
	<body class="progressbody">
		...
		<div id="shapeshomediv">
    		<div class="container">
    			<div class="row">
    					<center><h1 class="progressletters" id="pro1">Subtraction Activity Progress</h1></center>
    					<center><h5 id="pro2">Below are the results of the activies to test your understanding of subtraction.</h5></center>
    			</div>
    			<br>
    			<div class="progresstable">
	    			<div class="row progressrow">
	    				...
	    				<div class="col-sm-3"><center><div class="progressnum" >Subtraction</div></center></div>
	    				<div class="col-sm-1"></div>
	    				<div class="col-sm-2"><center><div class="progressnum" id="sub_errors"></div></center></div>
	    				<div class="col-sm-1"></div>
	    				<div class="col-sm-4"><center><div class="progressnum" id="sub_correct"></div></center></div>
